...
histograma1 <- hist(
  dadosCaptura$registro[dadosCaptura$idRecurso == 3],
  breaks = seq(0, 100, by = 10),
  freq = TRUE,
  col = "#4E2E9E",
  main = "Histograma de Uso Geral de Máquinas",
  xlab = "Faixas de uso (%)",
  ylab = "Frequência",
  right = FALSE,
  xlim = c(0, 100),
...
text(x = histograma1$mids, 
     y = histograma1$counts,
     labels = histograma1$counts, 
     pos = 3,
     cex = 0.8,) 
...
faixas <- seq(0, 100, by=10)
histograma2 <- hist(
  dadosCaptura$registro[dadosCaptura$idRecurso == 1],
  breaks = seq(0, 100, by = 10),
  freq = TRUE,
  col = "#4E2E9E",
  main = "Histograma de Uso Geral de Máquinas",
...
text(x = histograma2$mids, 
     y = histograma2$counts,
     labels = histograma2$counts, 
     pos = 3,
     cex = 0.8,) 
...
faixas <- seq(0, 100, by=10)
histograma3 <- hist(
  dadosCaptura$registro[dadosCaptura$idRecurso == 2],
  breaks = seq(0, 100, by = 10),
  freq = TRUE,
  col = "#4E2E9E",
  main = "Histograma de Uso Geral de Máquinas",
...
text(x = histograma3$mids, 
     y = histograma3$counts,
     labels = histograma3$counts, 
     pos = 3,
     cex = 0.8,) 
...
kable(top_5_mais_usadas, caption = "Máquinas mais usadas")
kable(top_5_menos_usadas, caption = "Máquinas menos usadas")
...
#### Média de Download: **`r m_download`**
#### Média de Upload: **`r m_upload`**

#### Tamanho médio de pacotes: **`r tamanhoMedioPacote`**
...
ranking <- df_recursos %>%
  slice_max(order_by = qtdAlertas, n = 14)

kable(ranking, caption = "Ranking dos Recursos com Mais Alertas")
